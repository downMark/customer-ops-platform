/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5ce3bd2ad72a41b23190c70df40bd027)
// Runtime types generated with workerd@1.20260722.1 2026-07-23 nodejs_compat
interface __BaseEnv_Env {
	MODEL_API_BASE_URL: "http://staging-model-api.example.com" | "http://model-api.example.com" | "http://localhost:4111";
	PORT: string;
	VITE_API_BASE_URL: string;
	SSR_API_BASE_URL: string;
	VITE_CHAT_API_BASE_URL: string;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./build/worker/worker");
	}
	interface StagingEnv {
		MODEL_API_BASE_URL: "http://staging-model-api.example.com";
		PORT: string;
		VITE_API_BASE_URL: string;
		SSR_API_BASE_URL: string;
		VITE_CHAT_API_BASE_URL: string;
	...
	interface ProductionEnv {
		MODEL_API_BASE_URL: "http://model-api.example.com";
		PORT: string;
		VITE_API_BASE_URL: string;
		SSR_API_BASE_URL: string;
		VITE_CHAT_API_BASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL_API_BASE_URL" | "PORT" | "VITE_API_BASE_URL" | "SSR_API_BASE_URL" | "VITE_CHAT_API_BASE_URL">> {}
}
